\appendix
\section{BLiMP and (Super)GLUE Task Scores}
\label{appendix}
...
\begin{table*}
    \centering
    \caption{(Super)GLUE scores for GPT-Neo, RoBERTa, and their sparse variants.}
    \label{tab:superglue}
\small
...
\begin{table*}
\centering
    \caption{BLiMP scores for GPT-Neo, RoBERTa, and their sparse variants.}
    \label{tab:blimp}
\tiny
\setlength{\tabcolsep}{1pt}
\input{blimp}
